 ...
 * @returns {string|undefined} The last element of the array, the last character of the string (or empty string if trimmed input is empty), or undefined if the input is not a non-empty array or a valid string.
 */
const getLast = (value: any[] | string, trim: boolean = false): string | undefined => {
